...
export const Group: Story & { args: { content1: string; content2: string } } = {
  ...
  render: (args) => ({
    ...
    template: container(`
       <n-button-group :type="args.groupType" :size="args.groupSize" :disabled="args.groupDisabled">
         <n-button v-bind="args">{{args.content1}}</n-button>
         <n-button v-bind="args">{{args.content2}}</n-button>
       </n-button-group>
    `),
  }),
  play: async ({ canvasElement, args, step }) => {
